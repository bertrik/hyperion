...
0x27, 0x00, 0x00, 0x05, 0x00, 0xFA, 0x00, 0xFA, 0x00, 0x64, 0x00, 0x2C, 0x01, 0x00, 0x00, 0x00, 0x00,
...
void loop()
{
    ...
    n = sprintf(superbuffer, "$$HYPERION,%d,%02d:%02d:%02d,%s,%s,%ld,%d,%d,%s,%d,%d,%d", count,
                hour, minute, second, latbuf, lonbuf, ialt, numbersats, navmode, b_press_s, temp0,
                temp1, b_temperature);
    if (n > -1) {
